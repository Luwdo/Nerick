var ngm = angular.module(module.exports = 'nerick.ui.artwork.details', [
	'ngRoute',
	'datatables',
	require('../../api'),
]);

ngm.module('artwork').config(['$routeProvider',
...
ngm.controller('ArtworkController', function($rootScope, $scope, $lightBox, $routeParams, $location, $NotifyService, $compile, DTOptionsBuilder, DTColumnBuilder, DTInstances) {
